...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get card_upright_major_03 => '豊かさ、母性愛、美しさ、自然の恵み、創造性';

  @override
  String get card_reversed_major_03 => '過保護、依存性、創造性の欠如、怠惰、停滞期';
  ...
  @override
  String get card_reversed_major_05 => '反逆、慣習打破、独断的な態度、古い思想、悪い助言';

  @override
  String get card_name_major_06 => 'VI. 恋人 (The Lovers)';

  @override
  String get card_upright_major_06 => '愛、調和、関係、重要な選択、信頼';

  @override
  String get card_reversed_major_06 => '不和、誤った選択、信頼喪失、誘惑、不均衡';

  @override
  String get card_name_major_07 => 'VII. 戦車 (The Chariot)';

  @override
  String get card_upright_major_07 => '意志、勝利、決断力、方向性、成功への推進力';

  @override
  String get card_reversed_major_07 => '制御喪失、方向喪失、無気力、攻撃性、障害物';
  ...
  @override
  String get card_upright_major_09 => '内面探求、知恵、孤独、悟り、精神的助言者';

  @override
  String get card_reversed_major_09 => '孤立、孤独、現実逃避、愚かな頑固さ、隠遁';

  @override
  String get card_name_major_10 => 'X. 運命の輪 (Wheel of Fortune)';

  @override
  String get card_upright_major_10 => '転換点、運命、幸運、絶え間ない変化、機会';

  @override
  String get card_reversed_major_10 => '不運、抵抗、制御不能な変化、不幸の繰り返し';
  ...
  @override
  String get card_upright_major_13 => '終わりと新たな始まり、変化、転換期、過去の清算';

  @override
  String get card_reversed_major_13 => '変化への抵抗、停滞、古いものへの執着、恐れ';
  ...
  @override
  String get card_name_major_18 => 'XVIII. 月 (The Moon)';

  @override
  String get card_upright_major_18 => '不安、幻想、直感、隠された真実、欺瞞';

  @override
  String get card_reversed_major_18 => '恐れの克服、秘密の発見、不安解消、真実の究明';
  ...
  @override
  String get card_upright_major_20 => '復活、決断、許し、新たな使命、内なる覚醒';

  @override
  String get card_reversed_major_20 => '後悔、自己不信、変化への恐れ、未練、刑罰';
  ...
  @override
  String get card_name_cups_01 => 'カップのエース (Ace of Cups)';
  ...
  @override
  String get card_upright_cups_02 => '関係の調和、結合、愛、相互尊重、協力';

  @override
  String get card_reversed_cups_02 => '関係の不和、別れ、誤解、不均衡、片思い';
  ...
  @override
  String get card_upright_cups_05 => '喪失、悲しみ、過去への後悔、悲観主義';

  @override
  String get card_reversed_cups_05 => '喪失の克服、受容、癒し、新たな希望の発見';

  @override
  String get card_name_cups_06 => 'カップ 6 (Six of Cups)';
  ...
  @override
  String get card_upright_cups_07 => '幻想、夢、選択の混乱、現実逃避、白昼夢';

  @override
  String get card_reversed_cups_07 => '現実直視、明確な目標、幻想からの目覚め、決断';
  ...
  @override
  String get card_upright_pentacles_08 => '職人技、専念、細部への注意、熟練';

  @override
  String get card_reversed_pentacles_08 => '退屈、完璧主義の罠、怠惰、情熱喪失';

  @override
  String get card_name_pentacles_09 => 'ペンタクル 9 (Nine of Pentacles)';
  ...
  @override
  String get card_upright_pentacles_10 => '家業、富の蓄積、遺産、安定した生活、伝統';

  @override
  String get card_reversed_pentacles_10 => '財産損失、家族紛争、伝統への反抗、不安定';
  ...
  @override
  String get card_name_pentacles_13 => 'ペンタクルのクイーン (Queen of Pentacles)';
  ...
  @override
  String get card_name_swords_10 => 'ソード 10 (Ten of Swords)';
  ...
  @override
  String get card_name_swords_14 => 'ソードのキング (King of Swords)';
  ...
  @override
  String get card_name_wands_02 => 'ワンド 2 (Two of Wands)';

  @override
  String get card_upright_wands_02 => '計画、ビジョン、長期的目標、決断力、探求';

  @override
  String get card_reversed_wands_02 => '計画不足、先延ばし、恐れによる停滞、限定されたビジョン';
  ...
  @override
  String get themeName1 => 'スキン1';

  @override
  String get themeName2 => 'スキン2';

  @override
  String get themeName3 => 'スキン 3';
  ...
  @override
  String get themeEmptyPaidThemes => 'ショップでスキンを購入する\nこのスペースを埋めるために！';

  @override
  String get shopThemePurchaseTitle => 'スキンを購入する';

  @override
  String shopThemePurchaseContent(String skinName, int cost) {
    return '$skinName スキンを $cost コインで購入しますか?';
  }
  ...
  @override
  String get shopAlreadyOwned => 'すでに所有しています。スキン設定から適用してみてください！';

  @override
  String shopPurchaseSuccess(String skinName) {
    return '$skinName は正常に購入されました。スキン設定を確認してください。';
  }
  ...
  @override
  String get myMenuThemeSettings => 'スキン設定';
  ...
  @override
  String get shopSubtitle => 'コインとスキンを購入する';

  @override
  String get shopTabCoin => 'コイン';

  @override
  String get shopTabTheme => '肌';
  ...
  @override
  String get themeFree => 'フリースキン';

  @override
  String get themePaid => '有料スキン';
  ...
  @override
  String get communityReportCancel => 'キャンセル';
  ...
  @override
  String get growthTabWorldTree => '世界樹を育てる';
  ...
  String growthCrystalBallLevel(int level) {
    return 'ミスティッククリスタルボールレベル $level';
  }
  ...
  @override
  String get chatShufflingCards => 'タロットカードをシャッフルしています...';

  @override
  String get profileEditEmptyNickname => 'ニックネームを入力してください。';
  ...
  @override
  String get profileEditErrorDefault => 'エラーが発生しました。';
  ...
  String profileEditErrorUnknown(String error) {
    return '保存中に不明なエラーが発生しました: $error';
  }
  ...
  @override
  String get growthTabMagicBook => '魔導書強化';

  @override
  String get growthPhaseCrystal0 => '深淵の魔力';

  @override
  String get growthPhaseCrystal1 => '霊眼開眼';

  @override
  String get growthPhaseCrystal2 => '大自然の叡智';

  @override
  String get growthPhaseCrystal3 => '太陽の精髄';

  @override
  String get growthPhaseCrystal4 => '天上のオーロラ';

  @override
  String get growthPhaseCrystal5 => '神聖なる領域';

  @override
  String get growthPhaseCrystal6 => '創造の魔術';

  @override
  String get growthPhaseCrystal7 => '宇宙の息吹';

  @override
  String get growthPhaseCrystal8 => '永遠の光';

  @override
  String get growthPhaseCrystal9 => '純白の覚醒';

  @override
  String get growthPhaseCrystal10 => '超越';

  @override
  String get growthPhaseBook0 => '見習いの筆記具';

  @override
  String get growthPhaseBook1 => '基礎魔術入門';

  @override
  String get growthPhaseBook2 => '古代ルーン文法';

  @override
  String get growthPhaseBook3 => '元素魔法の理解';

  @override
  String get growthPhaseBook4 => '星光の調和';

  @override
  String get growthPhaseBook5 => '遺物解読';

  @override
  String get growthPhaseBook6 => '賢者の禁書';

  @override
  String get growthPhaseBook7 => '精霊との交感';

  @override
  String get growthPhaseBook8 => '真実の魔導書';

  @override
  String get growthPhaseBook9 => '全能の記録';

  @override
  String growthMagicBookLevel(int level) {
    return '魔法書のレベル $level';
  }
  ...
  String growthCrystalBallMana(int current, int max) {
    return 'マナ: $current / $max';
  }

  @override
  String growthMagicBookExpGained(int amount) {
    return '魔法書の知識が深まりました！ 経験値 +$amount';
  }

  @override
  String growthUpgradeMagicBookButton(int amount) {
    return '魔法書を強化（粉 $amount個）';
  }

  @override
  String get devDustCharged => '開発用: 魔力の粉 1000個チャージ完了！';
  ...
  @override
  String get menuSectionNews => 'ニュースとお知らせ';

  @override
  String get menuMailboxTitle => 'メールボックス';

  @override
  String get menuMailboxSubtitle => '新しいアップデートやプレゼントをチェックする';

  @override
  String get mailboxTitle => 'メールボックス';

  @override
  String get mailboxAllRewardsClaimed => 'すべての報酬を受け取りました。';

  @override
  String get mailboxClaimAll => 'すべてを請求する';

  @override
  String get mailboxEmpty => 'メールボックスが空です。';

  @override
  String mailboxSenderAndDate(String sender, String date) {
    return '送信者: $sender • $date';
  }

  @override
  String get mailboxClaimed => '主張した';

  @override
  String get mailboxClaim => '請求';

  @override
  String get mailboxAttachedRewards => '付属の報酬';

  @override
  String get mailboxRewardClaimed => '報酬を請求しました。';

  @override
  String get mailboxClaimReward => '報酬を受け取る';

  @override
  String get menuNotificationCenterTitle => '通知センター';

  @override
  String get menuNotificationCenterSubtitle => '最新のお知らせやお知らせを確認する';

  @override
  String get authSignupComplete => 'サインアップが完了しました。確認のために送信されたメールをご確認ください。';
  ...
  @override
  String get diarySavedSuccess => '日記が無事保存されました！';
  ...
  @override
  String get diaryWriteHint => '今日の読書についての感想や感じたことを自由に書いてください。';

  @override
  String get diarySaveButton => '日記に保存';
  ...
  @override
  String get readingSpreadLabelToday => '今日の運勢';

  @override
  String get readingSpreadLabelPast1 => '1. 過去';

  @override
  String get readingSpreadLabelPresent2 => '2. プレゼント';

  @override
  String get readingSpreadLabelFuture3 => '3. 未来';

  @override
  String get readingSpreadLabelCurrent1 => '1. 現在';
  ...
  @override
  String get readingSpreadLabelPotential5 => '5. 可能性';

  @override
  String get readingSpreadLabelCurrentSituation1 => '1. 現状と課題';

  @override
  String get readingSpreadLabelCauseOfProblem2 => '2. 問題の原因';

  @override
  String get readingSpreadLabelAdviceForResolution3 => '3. 解決のためのアドバイス';

  @override
  String get readingSpreadLabelExpectedResult4 => '4. 期待される結果';

  @override
  String get readingSpreadLabelCurrentSituation1Alt => '1. 現状';

  @override
  String get readingSpreadLabelObstacle2 => '2. 障害物';

  @override
  String get readingSpreadLabelUnconscious3 => '3. 意識不明';

  @override
  String get readingSpreadLabelPast4 => '4. 過去';

  @override
  String get readingSpreadLabelConsciousGoal5 => '5. 意識的な目標';

  @override
  String get readingSpreadLabelNearFuture6 => '6. 近未来';

  @override
  String get readingSpreadLabelAttitude7 => '7. 態度';

  @override
  String get readingSpreadLabelExternalEnvironment8 => '8. 外部環境';

  @override
  String get readingSpreadLabelHopesAndFears9 => '9. 希望と恐怖';

  @override
  String get readingSpreadLabelFinalResult10 => '10. 最終結果';

  @override
  String get readingSpreadLabelAdvice4 => '4. アドバイス';

  @override
  String get readingSpreadLabelSurroundings5 => '5. 周辺環境';
  ...
  @override
  String get serviceLoginRequired => 'ログインが必要です。';

  @override
  String get serviceDefaultNickname => '名前のない魔女';

  @override
  String serviceTarotReadingError(String error) {
    return '占いの読み取り中にエラーが発生しました: $error';
  }

  @override
  String get defaultUserDisplayName => 'ユーザー';

  @override
  String get listenToInterpretation => '通訳を聞く';

  @override
  String get faqQ1 => 'タロットを毎日読んでもいいですか？';

  @override
  String get faqA1 =>
      'そう、今日の流れを軽い気持ちで読むと良いのです。ただし、同じ質問に対して繰り返しカードを引き続けることはお勧めできません。';

  @override
  String get faqQ2 => '魔法の粉はどうやって入手できますか？';

  @override
  String get faqA2 => '神秘的なタロット占いを見るたびに、1回につき10個の魔力の粉を基本として獲得できます！';

  @override
  String get faqQ3 => '結果が悪かった場合はどうすればよいですか?';

  @override
  String get faqA3 =>
      'タロットは確定した未来ではなく、アドバイスです。悪い結果をマイルストーンとして使用して、回避すべきリスクを警告します。';

  @override
  String get faqQ4 => '過去のタロット占いはどうやって見ることができますか？';

  @override
  String get faqA4 =>
      '下部メニューの「タロット日記」タブで、リストおよび日付別に保存されたリーディング記録をいつでも見返すことができます。';

  @override
  String get faqQ5 => 'コミュニティに共有するにはどうすればよいですか?';

  @override
  String get faqA5 =>
      'タロット日記に保存された日記詳細画面で、「コミュニティ公開」スイッチをオンにすると、他のユーザーとリーディングを共有できます。';

  @override
  String get faqQ6 => 'ニックネームやプロフィールを変更するにはどうすればよいですか?';

  @override
  String get faqA6 => '「マイメニュー」タブ上部のプロフィール領域をタップすると、いつでもニックネームとアイコンを変更できます。';

  @override
  String get faqQ7 => '通知のオンとオフはどこで切り替えられますか?';

  @override
  String get faqA7 =>
      '下部メニューの「マイメニュー」タブで、「プッシュ通知受信」スイッチを使っていつでも通知をオンまたはオフにできます。さまざまな特別イベントの特典や新しいタロットニュースを見逃さないようにするには、通知をオンにしておくことをお勧めします。';

  @override
  String get faqQ8 => '他の人のタロット日記を見ることはできますか?';

  @override
  String get faqA8 =>
      '上部のコミュニティアイコンをクリックすると、他の魔法使い（ユーザー）が公開設定した興味深いタロットリーディングを閲覧したり応援したりできます。';

  @override
  String get faqQ9 => 'プレミアム サブスクリプションまたは支払い履歴はどこで確認できますか?';

  @override
  String get faqA9 =>
      '下部の[マイメニュー]タブで「決済履歴」を選択すると、これまでに決済されたコイン履歴と獲得した魔力の粉を詳細に確認できます。';

  @override
  String get faqQ10 => '個人的にタロットカードの意味を勉強したいです。どうすればそれができますか？';

  @override
  String get faqA10 =>
      '下部メニューの【カード図鑑】タブでは、全78枚のカードの正位置・逆位置の意味やシンボル、詳しい解説を自由に閲覧することができます。';

  @override
  String get faqQ11 => 'アカウントを削除または退会するにはどうすればよいですか?';

  @override
  String get faqA11 =>
      '下部メニューの[マイメニュー]タブの下部に「会員退会」ボタンがあります。退会すると、すべての日記とデータは永久的に削除されます。';

  @override
  String get faqQ12 => 'エラーが発生した場合、または提案がある場合はどこに連絡すればよいですか?';

  @override
  String get faqA12 =>
      '現在の画面の下部に準備中の「カスタマーサービスに連絡する」または公式メールを通じて詳細を送信していただければ、すぐに確認し、魔法のように解決します。';

  @override
  String get faqQ13 => '別のメールアドレスで会員登録をしようとしたら警告画面が表示されますが、どうすればよいですか？';

  @override
  String get faqA13 =>
      '現在のシステムは、安全なデータ管理のため、1つのデバイス（アプリ）につき単一のメールアドレスのみで会員登録およびログインをサポートしています。別のメールアドレスで登録をご希望の場合は、アプリを完全に削除した後、再インストールして進めてください。';

  @override
  String get myMenuContactUs => 'お問い合わせ';

  @override
  String get myMenuContactUsSubtitle => 'お問い合わせとご提案';

  @override
  String get contactDialogTitle => 'お問い合わせ';

  @override
  String get contactTypeBug => 'バグレポート';

  @override
  String get contactTypeFeature => '機能の提案';

  @override
  String get contactTypePayment => '支払いの問題';

  @override
  String get contactTypeOther => 'その他のお問い合わせ';

  @override
  String get contactHint => 'お問い合わせ内容を詳しくご記入ください。';

  @override
  String get contactSend => '送信';

  @override
  String get contactCancel => 'キャンセル';

  @override
  String get contactEmptyErrorTitle => '知らせ';

  @override
  String get contactEmptyErrorMessage => 'お問い合わせ内容をご入力ください。';
