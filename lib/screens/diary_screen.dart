                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text(
                                '${diary.spreadType == "?€ë¡??ë‹´" ? AppLocalizations.of(context)!.diaryTarotConsult : AppLocalizations.of(context)!.diaryTarotReading} - ${TarotLocalizations.getName(context, card.id)}${diary.cardIds.length > 1 ? " ${AppLocalizations.of(context)!.diaryAndMore(diary.cardIds.length - 1)}" : ""}',
                              ...
                              SizedBox(height: 8),
                              if (diary.myNote.isNotEmpty && diary.myNote != '?€ë¡?ë¦¬ë”©')
                                Container(
