...
class _DiaryDetailScreenState extends State<DiaryDetailScreen> {
  ...
  void _translateDiary() async {
    ...
    try {
      ...
      if (translatedNote.isNotEmpty && translatedNote != '?ÄÎ°?Î¶¨Îî©' && translatedNote != AppLocalizations.of(context)!.diaryTarotReading) {
  ...
  Widget build(BuildContext context) {
    ...
    if (_diary.spreadType == '?ÄÎ°??ÅÎã¥' || _diary.spreadType == AppLocalizations.of(context)!.diaryTarotConsult) {
